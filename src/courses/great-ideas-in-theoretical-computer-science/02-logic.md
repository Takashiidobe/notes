...
Prev: [[courses/great-ideas-in-theoretical-computer-science/01-introduction]]
Next: [[03-circuits-and-finite-automata]]
...
These sentences cannot all be satisified. We can think about this as a graph, where $A \implies B$ and $B \implies C$ is a graph of $A \rightarrow B \rightarrow C$.
