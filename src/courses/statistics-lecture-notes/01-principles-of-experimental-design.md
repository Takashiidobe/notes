...
pdf: "[[statistics-lecture-notes.pdf]]"
---

# Principles of experimental design

Next: [[02-test-statistics-and-randomization-distributions]]
...
- **Observational Studies**: Input and output variables are observed from a pre-existing population. It is hard to discern what is input and what is output.
...
3. **Conclusion**: Estrogen treatment is positively associated with health outcomes, such as prevalence of heart disease.
