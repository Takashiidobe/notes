...
source: "https://clickhouse.com/blog/optimizing-clickhouse-intel-high-core-count-cpu"
author:
  - "[[ClickHouse]]"
published: 2025-09-06
created: 2025-09-17
description: "Intel's latest processor generations are pushing the number of cores in a server to unprecedented levels. For analytical databases like ClickHouse, ultra-high core counts represent a huge opportunity and a complex challenge."
tags:
  - "clippings"
---
...
### Optimization 1.1: Query condition cache (PR #80247)
...
### Optimization 1.2: Thread-Local Timer ID (PR #48778)
...
### Optimization 2.1: Jemalloc Memory Reuse Optimization (PR #80245)
...
### Optimization 2.2: AST Query Rewriting for Memory Reduction (PR #57853)
...
### Optimization 3.1: Hash Table Conversion (PR #50748)
...
![intel_img_2.png](https://clickhouse.com/uploads/intel_img_2_d019431938.png) *Pipeline visualization (max\_threads=80) - the merge phase is reasonable* ![intel_img_3.png](https://clickhouse.com/uploads/intel_img_3_b28b847281.png) *Pipeline visualization (max\_threads=112) - the merge phase takes 3.2x longer*
...
### Optimization 3.2: Single-Level Hash Table Merging (PR #52973)
...
### Optimization 3.3: Parallel Merge with Key Support (PR #68441)
...
![intel_img_5.png](https://clickhouse.com/uploads/intel_img_5_64dd7ef454.png) *Perf analysis showing 36.6% cycles in ProfileEvents::increment*
...
![intel_img_6.png](https://clickhouse.com/uploads/intel_img_6_d32f81bea1.png) *After optimization: ProfileEvents::increment drops to 8.5% (from 36.6%)*
...
![intel_img_7.png](https://clickhouse.com/uploads/intel_img_7_651eaa2f76.png) *ClickBench Q3: 27.4% improvement, with larger gains on higher core count systems*
