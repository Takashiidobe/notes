 ...
 * are multiple such indices j, you can only jump to the smallest such index
 * j.
 ...
 * Output: 2
 * Explanation: 
 * From starting index i = 0, we can make our 1st jump to i = 2 (since A[2] is
 * the smallest among A[1], A[2], A[3],
