...
# Output: 9
# Explanation:
# 1. 10 customers arrive, 4 board and 6 wait, the wheel rotates. Current profit
# is 4 * $3 - 1 * $8 = $4.
# 2. 10 customers arrive, 4 board and 12 wait, the wheel rotates. Current
# profit is 8 * $3 - 2 * $8 = $8.
# 3. 6 customers arrive, 4 board and 14 wait, the wheel rotates. Current profit
# is 12 * $3 - 3 * $8 = $12.
# 4. 4 customers arrive, 4 board and 14 wait, the wheel rotates. Current profit
# is 16 * $3 - 4 * $8 = $16.
# 5. 7 customers arrive, 4 board and 17 wait, the wheel rotates. Current profit
# is 20 * $3 - 5 * $8 = $20.
# 6. 4 board and 13 wait, the wheel rotates. Current profit is 24 * $3 - 6 * $8
# = $24.
...
# = $32.
# 9. 4 board and 1 waits, the wheel rotates. Current profit is 36 * $3 - 9 * $8
# = $36.
